		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#googleimagem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"googleimagem-display": {
								"semanticObject": "googleimagem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=googleimagem",
									"url": sap.ui.require.toUrl("googleimagem")
								}
							}
						}
					}
